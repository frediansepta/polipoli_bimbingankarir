<?php
    ...
    GROUP BY dp.id, daftar_poli.id, poli.nama_poli, dokter.nama, jadwal_periksa.hari, jadwal_periksa.jam_mulai, jadwal_periksa.jam_selesai, daftar_poli.no_antrian, p.id, p.tgl_periksa, p.catatan, p.biaya_periksa");
